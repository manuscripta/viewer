        ...
        <xsl:choose>
            <xsl:when test="parent::msItem">
                <xsl:if test="@scheme='folios'">
                    <xsl:choose>
                        <xsl:when test="@from = @to">
                            <span class="locus">(f. <a onclick="$('#diva-wrapper').data('diva').gotoPageByName('{//surface[@xml:id=concat(//TEI/@xml:id,'-',$locusFrom)]/graphic/@url}')" href="#">
                                    <xsl:value-of select="@from"/>
                                </a>)<xsl:text> </xsl:text>
                            </span>
                        </xsl:when>
                        <xsl:otherwise>
                            <span class="locus">(ff. <a onclick="$('#diva-wrapper').data('diva').gotoPageByName('{//surface[@xml:id=concat(//TEI/@xml:id,'-',$locusFrom)]/graphic/@url}')" href="#">
                                    <xsl:value-of select="@from"/>
                ...
                <xsl:if test="@scheme='pages'">
                    <xsl:choose>
                        <xsl:when test="@from = @to">
                            <span class="locus">(p. <a onclick="$('#diva-wrapper').data('diva').gotoPageByName('{//surface[@xml:id=concat(//TEI/@xml:id,'-',$locusFrom)]/graphic/@url}')" href="#">
                                    <xsl:value-of select="@from"/>
                                </a>)<xsl:text> </xsl:text>
                            </span>
                        </xsl:when>
                        <xsl:otherwise>
                            <span class="locus">(pp. <a onclick="$('#diva-wrapper').data('diva').gotoPageByName('{//surface[@xml:id=concat(//TEI/@xml:id,'-',$locusFrom)]/graphic/@url}')" href="#">
                                    <xsl:value-of select="@from"/>
                                </a>–<a onclick="$('#diva-wrapper').data('diva').gotoPageByName('{//surface[@xml:id=concat(//TEI/@xml:id,'-',$locusTo)]/graphic/@url}')" href="#">
                                    <xsl:value-of select="@to"/>
                                </a>)<xsl:text> </xsl:text>
                ...
                <xsl:if test="@scheme='other'">
                    <xsl:choose>
                        <xsl:when test="@from = @to">
                            <span class="locus">(<a onclick="$('#diva-wrapper').data('diva').gotoPageByName('{//surface[@xml:id=concat(//TEI/@xml:id,'-',$locusFrom)]/graphic/@url}')" href="#">
                                    <xsl:value-of select="@from"/>
                                </a>)<xsl:text> </xsl:text>
                            </span>
                        </xsl:when>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <span class="locus">
                                ...
                                –
                                <a onclick="$('#diva-wrapper').data('diva').gotoPageByName('{//surface[@xml:id=concat(//TEI/@xml:id,'-',$locusTo)]/graphic/@url}')" href="#">
                                    <xsl:value-of select="@to"/>
                                </a>
                                <xsl:text> </xsl:text>
                            </span>
